...
After determining the chance that the game ends with a certain scoreline, ODM-S sum the probabilities of scorelines that end with win, tie or loss for Germany to get the prediction of it winning, drawing or losing against Ukraine.
